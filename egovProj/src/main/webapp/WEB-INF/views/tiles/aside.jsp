...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="index3.html" class="brand-link"> <img
		...
		style="opacity: .8"> <span class="brand-text font-weight-light">BOOOOOOOOK</span>
	</a>
	...
	<div class="sidebar">
		...
		<sec:authorize access="isAuthenticated()">
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<div class="image">
					<img
						src="/resources/upload/<sec:authentication property="principal.memberVO.memId" />.jpg"
						class="img-circle elevation-2" alt="User Image">
				</div>
				<div class="info">
					<a href="#" class="d-block"> <sec:authentication property="principal.memberVO.memName" />
		...
		<ul class="nav nav-pills nav-sidebar flex-column"
			...
			<li class="nav-item"><a href="#" class="nav-link"> <i
				...
				<ul class="nav nav-treeview">
					...
					<li class="nav-item"><a href="pages/layout/fixed-sidebar.html"
						class="nav-link"> <i class="far fa-circle nav-icon"></i>
							<p>Fixed Sidebar</p>
					</a></li>
					<li class="nav-item"><a
					...
					<li class="nav-item"><a
						href="pages/layout/collapsed-sidebar.html" class="nav-link"> <i
							class="far fa-circle nav-icon"></i>
			...
			<li class="nav-item"><a href="#" class="nav-link"> <i
				...
				<ul class="nav nav-treeview">
					...
					<li class="nav-item"><a href="pages/examples/project-add.html"
						class="nav-link"> <i class="far fa-circle nav-icon"></i>
							<p>Project Add</p>
					</a></li>
					<li class="nav-item"><a
